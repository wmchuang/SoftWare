...
namespace Software.Services.Base
{
    public class BaseServices<TEntity> : IBaseServices<TEntity> where TEntity : class, new()
    {
        ...
        public async Task<TEntity> QueryByID(Expression<Func<TEntity, bool>> expression)
        {
            return await baseDal.QueryByID(expression);
        }
        ...
        /// <returns></returns>
        public async Task<int> AddNoIdentity(TEntity entity)
        {
            return await baseDal.AddNoIdentity(entity);
        }
        ...
        List<TEntity> IBaseServices<TEntity>.QueryPage(ref int totalCount, Expression<Func<TEntity, bool>> whereExpression, int intPageIndex, int intPageSize, string strOrderByFileds)
        {
            return baseDal.QueryPage(ref totalCount, whereExpression,
           intPageIndex, intPageSize, strOrderByFileds);
        }

        public async Task<bool> QueryAnyAsync(Expression<Func<TEntity, bool>> whereExpression)
        {
            return await baseDal.QueryAnyAsync(whereExpression);
        }

        public async Task<dynamic> SqlQueryDynamic(string spName, object whereObj = null)
        {
            return await baseDal.SqlQueryDynamic(spName, whereObj);
        }
